    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="/game">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            <label for="event-name" class="block text-sm font-medium leading-6 text-gray-900">Name for Capital</label>
                            <div class="mt-2">
                                <input required type="text" name="event-name" id="event-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="additional-capital" class="block text-sm font-medium leading-6 text-gray-900">Additional Capital</label>
                            <div class="mt-2">
            ...
            <div class="mt-6 flex items-center justify-begin gap-x-6">
                <input hidden name="action" value="add-capital">
