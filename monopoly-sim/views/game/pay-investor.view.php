    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="/game">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="additional-capital" class="block text-sm font-medium leading-6 text-gray-900">Additional Payment to Investor</label>
                            <div class="mt-2">
            ...
            <div class="mt-6 flex items-center justify-begin gap-x-6">
                <input hidden name="action" value="pay-investor">
